...
Después de la pandemia de COVID-19 la dinámica de la inflación por regiones geográficas parece haber cambiado. El siguiente mapa muestra los valores de inflación acumulada en cada región del país desde febrero de 2021. Hasta `r meses[mes_t,1]`  de `r year_t`, la región que más inflación acumuló fue la región Gran Buenos Aires, mientras que la región que menos inflación acumuló fue la región Noreste. En el Gran Buenos Aires el nivel general de precios acumulado fue de 1753.7 por ciento mientras que en la región Noreste fue de 1641.9 por ciento (Figura 7).
...
La Figura 10 muestra que la brecha de inflación acumulada entre el decil 1 y el decil 10. Si consideramos esta brecha desde 2016, panel de la izquierda, se puede ver que los hogares de muy bajos ingresos enfrentaron una inflación acumulada mayor que los hogares de muy altos ingresos en todas lasregiones del país. En la región del GBA es donde la brecha fue mayor alcanzando 93 puntos porcentuales mientras que la menor brecha de dió en la región de Cuyo con casi 34 puntos porcentuales. La situación cambia si se considera esta brecha desde 2021 porque las únicas dos regiones del país donde la brecha resulta positiva son GBA y Noroeste. En el resto de las regiones del país los hogares de muy altos ingresos enfrentaron una inflación mayor que los hogares de muy bajos ingresos.
...
La Figura 11 muestra el impacto diferencial de la inflación interanual por deciles de ingreso per cápita familiar para las diferentes regiones del país en `r meses[mes_t,1]` de 2024. Como se observa la brecha de inflación por deciles de ingreso es positiva solo en la región Patagonia. En el resto de las regiones los hogares de muy bajos ingresos enfrentaron una inflación que va desde 2.3 puntos porcentuales más baja que los hogares de muy altos ingresos en la región del GBA, hasta 9.5 puntos porcentuales más baja en la región Noroeste. En el total del país, estos hogares de bajos ingresos enfrentaron una inflación  `r sprintf("%.2f",cuadro1deciles[12,4])` puntos porcentuales más baja que los hogares de muy altos ingresos, como se reporta en el Cuadro 2.
