...
La Figura 2 muestra las diferencias entre las contribuciones a la tasa de inflación interanual de `r meses[mes_t,1]` del 20 por ciento de los hogares de menores y mayores ingresos. **La división de Alimentos y bebidas no alcohólicas contribuyó a incrementar más la inflación para los hogares de menores ingresos en comparación con los hogares de mayores ingresos.** En particular, esta división explicó más de 45 puntos porcentuales de la diferencia. En comparación, Transporte, Salud, y Restaurantes y hoteles fueron las divisiones que contribuyeron para aumentar más la tasa de inflación que enfrentó el grupo de hogares de mayores ingresos en comparación con los hogares de menores ingresos. Estas tres divisiones contribuyeron a reducir la brecha en la inflación enfrentada por los hogares de menores y mayores ingresos en alrededor de 35 puntos porcentuales. 
...
La figura 4 muestra la diferencia entre la tasa de inflación interanual, nivel general y núcleo, experimentada por los hogares del decil 1 (muy bajos ingresos) y por los hogares del decil 10 (muy altos ingresos) desde 2017 en adelante. Un valor positivo indica que los hogares de menores ingresos experimentaron una inflación interanual mayor que la enfrentada por los hogares de mayores ingresos. Como se puede observar en la figura  la brecha de inflación por deciles de ingreso tiene menor volatilidad para la inflación núcleo que para el nivel general. Observando el comportamiento de esta brecha para la inflación núcleo (excluye bienes y servicios cuyos precios están sujetos a regulación o tienen alto componente impositivo -combustibles para la vivienda, electricidad, agua y servicios sanitarios, sistemas de salud y servicios auxiliares, transporte público de pasajeros, funcionamiento y mantenimiento de vehículos, correo, teléfono, educación formal y cigarrillos y accesorios- y aquellos con comportamiento estacional -frutas, verduras, ropa exterior, transporte por turismo y alojamiento y excursiones-) se pueden identificar tres períodos temporales. Hasta fines del 2021 la brecha es positiva indicando que la inflación que enfrentaron los hogares de menores ingresos fue mayor a la que enfrentaron los hogares de mayores ingresos. A partir de 2022 la brecha se vuelve negativa hasta agosto de 2023 y regresa a valores positivos a partir de septiembre de 2023 hasta febrero de 2024. **A partir de marzo del corriente año la brecha de inflación entre el decil 1 (menores ingresos) y el decil 10 (mayores ingresos) es negativa alcanzando -4.92 puntos porcentuales en el mes de `r meses[mes_t,1]`** 

En líneas generales y a pesar de la mayor volatilidad, la brecha de inflación por deciles de ingreso medida con el nivel general tiene una evolución similar salvo por el período que va desde febrero de 2022 hasta julio de 2023 cuando la brecha de inflación medida para la núcleo es negativa mientras que medida por el nivel general es positiva. **En junio y julio la brecha de inflación interanual entre el decil 1 y el decil 10 volvió a ser positiva llegando a 1.17 puntos porcentuales en julio para hacerce negativa con un valor de -1.53 puntos porcentuales en agosto.** Esto indica que los hogares de muy bajos ingresos enfrentaron una inflación menor a la que enfrentaron los hogares de muy altos ingresos en el mes de `r meses[mes_t,1]`.   

[**Figura 4. Diferencia en las tasas de inflación _interanual_ experimentadas por el decil 1 y el decil 10**]{style="color:#777;font-size:13    .0pt;"}

```{r national_ineq_headline_core_yoy, message=FALSE, echo=FALSE, warning=FALSE}
...
map_f10 <- leaflet(ar_regiones_gba_data) %>%
  ...
  setView(lng = -62.0, lat = -38.0, zoom = 4) %>%
...
Después de la pandemia de COVID-19 la dinámica de la inflación por regiones geográficas parece haber cambiado. El siguiente mapa muestra los valores de inflación acumulada en cada región del país desde febrero de 2021. Hasta `r meses[mes_t,1]`  de `r year_t`, la región que más inflación acumuló fue la región Gran Buenos Aires, mientras que la región que menos inflación acumuló fue la región Noreste. En el Gran Buenos Aires el nivel general de precios acumulado fue de 1690.9 por ciento mientras que en la región Noreste fue de 1590.0 por ciento (Figura 7).
...
La Figura 9 muestra la brecha de inflación interanual por deciles de ingreso desde 2016 en el panel de la izquierda y desde 2021 en el panel de la derecha para las diferentes regiones del país. Esto es el promedio de la diferencia entre la inflación interanual que enfrentaron los hogares del decil 1 (muy bajos ingresos) y la inflación interanual que enfrentaron los hogares del decil 10 (muy altos ingresos). Un valor positivo indica que la inflación interanual que enfrentaron los hogares de muy bajos ingresos fue mayor a la que enfrentaron los hogares de muy altos ingresos. Ambos paneles cuentan la misma historia, la brecha de inflación por deciles de ingreso es positiva tanto desde 2016 como desde 2021. Sin embargo, las regiones con mayor y menor brecha cambian. El panel de la izquierda muestra que la brecha de inflación por deciles de ingreso fue más alta en la región Noroeste alcanzando casi 1 punto porcentual y fue más baja en la región Noreste con una brecha de casi 0.4 puntos porcentuales. Si tomamos la brecha desde 2021, panel derecho de la figura, en un extremo se encuentra la región Patagonia con una brecha por deciles de 1.47 puntos porcentiales y en el otro la región Noreste donde la brecha fue solo de 0.14 puntos porcentuales.
...
Si en lugar de trabajar con la inflación interanual consideramos la inflación acumulada desde 2016 o desde 2021 tenemos la misma historia. La Figura 10 muestra que la brecha promedio de inflación acumulada entre el decil 1 y el decil 10 fue positiva indicando que los hogares de muy bajos ingresos enfrentaron una inflación acumulada mayor que los hogares de muy altos ingresos, tanto desde 2016 como desde 2021. Igual que con la inflación interanual la mayor brecha entre el decil 1 y el decil 10 se dió en la región Noroeste si miramos desde 2016 y la región Patagonia si la miramos desde 2021.
...
La Figura 11 muestra el impacto diferencial de la inflación interanual por deciles de ingreso per cápita familiar para las diferentes regiones del país en `r meses[mes_t,1]` de 2024. Como se observa la brecha de inflación por deciles de ingreso es heterogénea entre regiones. En la región Patagonia los hogares de muy bajos ingresos enfrentaron una inflación 4.1 puntos porcentuales más alta que los hogares de muy altos ingresos, en la región Noroeste enfrentaron una inflación interanual 7.5 puntos porcentuales más baja. En el total del país, estos hogares de bajos ingresos enfrentaron una inflación  `r sprintf("%.2f",cuadro1deciles[12,4])` puntos porcentuales más baja que los hogares de muy altos ingresos, como se reporta en el Cuadro 2.
